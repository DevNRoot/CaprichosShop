...
//   const setSubCategorias = useSubCategoriasStore((s) => s.setSubCategorias);
...
//   const subCategoriasFiltradas = findSubCategoria.trim()
//     ? subCategorias.filter((sc) =>
//         sc.nombre.toLowerCase().includes(findSubCategoria.toLowerCase())
//       )
//     : subCategorias;
